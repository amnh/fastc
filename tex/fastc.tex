...
\begin{grammar}
  ...
  <SPACING>      ::=  \verb![\s]!$^{+}$  $\,\quad\quad\quad \lhd \,\, \textbf{one or more spaces}$
                 \alt <COMMENT>
  ...
  <SPACE_CHAR>   ::=  \verb![^\n\S]!     $\,\quad\quad      \lhd \,\, \textbf{not a new-line or a non-space}$

  <INLINE_CHAR>  ::=  \verb![^\n]!       $\,\quad\quad\quad \lhd \,\, \textbf{not a new-line}$

  <VALID_CHAR>   ::=  \verb![^;>\[\]\s]! $                  \lhd \,\, \textbf{not}$ `;', `>', `[', `]', $\textbf{or a space}$
